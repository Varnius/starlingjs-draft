...
export default class Touch {
  ...
  toString() {
    return `[Touch ${this._id}: globalX=${this._globalX}, globalY=${
      this._globalY
    }, phase=${this._phase}]`
  }
  ...
  set globalX(value) {
    this._previousGlobalX =
      this._globalX !== this._globalX ? value : this._globalX // isNaN check
    this._globalX = value
  }
  ...
  set globalY(value) {
    this._previousGlobalY =
      this._globalY !== this._globalY ? value : this._globalY // isNaN check
    this._globalY = value
  }
