...
export default class DropShadowFilter extends FragmentFilter {
     ...
     */
    constructor(distance = 4.0, angle = 0.785, color = 0x0, alpha = 0.5, blur = 1.0, resolution = 0.5) {
        super();
    ...
    process(painter, helper, input0 = null) {
        ...
        const result = this._compositeFilter.process(painter, helper, shadow, input0);
