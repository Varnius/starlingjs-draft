...
export default class MatrixUtil {
  ...
  static transformCoords3D(matrix, x, y, z, out = null) {
    ...
    out.x =
      x * sRawData2[0] + y * sRawData2[4] + z * sRawData2[8] + sRawData2[12]
    out.y =
      x * sRawData2[1] + y * sRawData2[5] + z * sRawData2[9] + sRawData2[13]
    out.z =
      x * sRawData2[2] + y * sRawData2[6] + z * sRawData2[10] + sRawData2[14]
    out.w =
      x * sRawData2[3] + y * sRawData2[7] + z * sRawData2[11] + sRawData2[15]
  ...
  static createPerspectiveProjectionMatrix(
    ...
    out.prependTranslation(
      ...
      -focalLength * (width / stageWidth)
    ) // Stage3D z = [0, 1], WebGL z = [-1, 1] todo - added * (width / stageWidth)
