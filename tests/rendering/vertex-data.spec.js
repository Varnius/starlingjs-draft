...
describe('VertexData', () => {
  ...
  it('should allow to read/write simple attributes', () => {
    const vd = new VertexData(
      'pos1D:float1, pos2D:float2, pos3D:float3, pos4D:float4'
    )
    vd.numVertices = 3
  ...
  it('should allow to copyTo with different formats', () => {
    ...
    Helpers.comparePoints(
      vd1.getPoint(0, 'texCoords'),
      vd2.getPoint(0, 'texCoords')
    )
    Helpers.comparePoints(
      vd1.getPoint(1, 'texCoords'),
      vd2.getPoint(1, 'texCoords')
    )
    ...
    Helpers.comparePoints(
      vd1.getPoint(0, 'texCoords'),
      vd3.getPoint(0, 'texCoords')
    )
    Helpers.comparePoints(
      vd1.getPoint(1, 'texCoords'),
      vd3.getPoint(1, 'texCoords')
    )
