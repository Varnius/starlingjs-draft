...
export default class Texture {
     ...
     */
    //static fromData(data, options = null)
    //{
     ...
     *                 efficient "RectangleTexture".
     */
    static fromColor(width, height,
                     color = 0xffffff, alpha = 1.0,
                     optimizeForRenderToTexture = false,
                     scale = -1, format = 'bgra',
                     forcePotTexture = false)
    {
        const texture = Texture.empty(width, height, true, false, optimizeForRenderToTexture, scale, format, forcePotTexture);
     ...
     *                 efficient "RectangleTexture".
     */
    //static empty(width, height, premultipliedAlpha = true, mipMapping = false, optimizeForRenderToTexture = false,
    //             scale = -1, format = 'bgra',
    //             forcePotTexture = false)
    //{
    ...
    //    var context:Context3D = Starling.context;
    //    
    //    if (context == null) throw new Error('[ContextError] Missing context');
    //    
    //    var origWidth  = width  * scale;
    //    var origHeight = height * scale;
    //    var useRectTexture = !forcePotTexture && !mipMapping &&
