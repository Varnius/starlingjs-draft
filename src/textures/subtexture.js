...
export default class SubTexture extends Texture {
  ...
  setTo(
    ...
    this._width =
      (rotated ? this._region.height : this._region.width) / scaleModifier
    this._height =
      (rotated ? this._region.width : this._region.height) / scaleModifier
    ...
    if (
      ...
      (this._frame.x > 0 ||
        this._frame.y > 0 ||
        this._frame.right < this._width ||
        this._frame.bottom < this._height)
    ) {
      console.warning(
  ...
  updateMatrices() {
    ...
    this._transformationMatrix.scale(
      this._region.width / this._parent.width,
      this._region.height / this._parent.height
    )
    this._transformationMatrix.translate(
      this._region.x / this._parent.width,
