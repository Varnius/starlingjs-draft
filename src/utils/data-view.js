...
export function copyFromDataView(source, target, sourceStartPos = 0, numBytes = -1, targetStartPos = 0) {
    let numBytesToCopy = numBytes !== -1 ? numBytes : source.byteLength - sourceStartPos;
