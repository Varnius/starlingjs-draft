...
export default class Matrix3D {
  ...
  toString() {
    const d = this._data
    return `
        ${d[0].toFixed(2)} ${d[1].toFixed(2)} ${d[2].toFixed(2)} ${d[3].toFixed(
      2
    )}
        ${d[4].toFixed(2)} ${d[5].toFixed(2)} ${d[6].toFixed(2)} ${d[7].toFixed(
      2
    )}
        ${d[8].toFixed(2)} ${d[9].toFixed(2)} ${d[10].toFixed(
      2
    )} ${d[11].toFixed(2)}
        ${d[12].toFixed(2)} ${d[13].toFixed(2)} ${d[14].toFixed(
      2
    )} ${d[15].toFixed(2)}
        `
  }
  ...
  prependTranslation(translationX, translationY, translationZ) {
    ...
    this._data[3] +=
      m00 * translationX + m10 * translationY + m20 * translationZ
    this._data[7] +=
      m01 * translationX + m11 * translationY + m21 * translationZ
    this._data[11] +=
      m02 * translationX + m12 * translationY + m22 * translationZ
    this._data[15] +=
      m03 * translationX + m13 * translationY + m23 * translationZ
  }
